...
public class GetCustomerByIdTests {
	...
	public void getAgencyById() {
		...
		ApiGatewayProxyResponse response = new GetCustomerById().handleRequest(request, context);
	...
	public void getAgencyById404() {
		...
		Mockito.when(request.getPathParameters()).thenReturn(pathParameters);
		ApiGatewayProxyResponse response = (ApiGatewayProxyResponse) new GetCustomerById().handleRequest(request,
				context);
